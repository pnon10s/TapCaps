...
Tap Caps is a small, fast, totally free utility for inserting your favorite symbols, emojis, and special characters from your own palette into any text box. Press the no‑look hotkey (Caps+A), tap a quick sequence, or click a character — Tap Caps pastes it instantly in its original color.

Tap Caps includes a fast quick‑tap sequence method that’s often quicker than navigating the mouse.

**Tap Caps is a Windows‑only utility, designed for speed, simplicity, and everyday use that I want to share.**

![Symbol Sets Preview](I.Love.You.TCC.gif)

![Symbol Sets Preview](Palette.Examples.TCC.jpg)
...
Extract the zip file in any secure place in your user folders and run TapCapsSetup.exe.   
You can modify a Symbol Set to your liking or copy and create SymbolSet4-9.txt.

- **TapCapsColor.zip** — Full color palette built with AutoHotKey v1 + Electron
- **TapCapsLite.zip** — Monochrome palette built with AutoHotKey v1 → still pastes in full color and the monochrome palette renders more quickly.

- **Hotkey Behavior** — Both builds use the same hotkey setup. Only one version can be activated using the hotkey.
